    ...
    <div class="app-content content ">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0 mx-2">Student Details</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <section id="input-file-browser">
                    <div class="card">
                        ...
                        <div class="card-body pt-1">
                            <!-- form -->
                            <form action="" method="POST" enctype="multipart/form-data" class="fw-bolder"
                                id="insertStudent">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                        <label class="form-label" for="qrcode">First Name<sup
                                                class="text-danger f-size12">*</sup></label>
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                        <label class="form-label" for="last_name">Last Name<sup
                                                class="text-danger f-size12">*</sup></label>
                                        <div class=" form-password-toggle">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                        <label class="form-label" for="mobile_self">Mobile(Self)<sup
                                                class="text-danger f-size12">*</sup></label>
                                        <div class=" form-password-toggle">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                        ...
                                        <div class=" form-password-toggle">
                                            <input class="form-control" type="number" id="mobile_parent"
                                                ...
                                                min="0" placeholder="Ex : +9856..." name="mobile_parent" />
                                            @error('mobile_parent')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                        <label class="form-label" for="mobile_self">Father Name<sup
                                                class="text-danger f-size12">*</sup></label>
                                        <div class=" form-password-toggle">
                                        ...
                                        <div class=" form-password-toggle">
                                            ...
                                            @if (auth()->user()->admin_role_id == 1)
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" >Convert</label>
                                                </div>
                                            @endif
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="status"
                                        ...
                                        <div class="card border border-info" style="width: 40rem; ">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-1 text-body-secondary">
                                                    Date-{{ date('d-m-Y', strtotime($followup->followupdate)) }}</h6>
                                            ...
                                            <div class="card-body pt-1">
                                                <div class="row">
                                                            ...
                                                            <select class="form-control" name="batch_id" required>
                                                                ...
                                                                @if (isset($batches))
                                                                    @foreach ($batches as $batch)
                                                                        <option
                                                                            {{ isset($studentDetails->batch_id) && $studentDetails->batch_id == $batch->id ? 'selected' : '' }}
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <input type="text" name="id_number"
                                                            value="{{ isset($studentDetails->id_no) ? $studentDetails->id_no : '' }}"
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        <label for="first_installment_amount">First Instalment Amount<sup
                                                                class="text-danger f-size12">*</sup></label>
                                                        <input type="text" name="first_instalment_amount"
                                                            value="{{ isset($studentDetails->fee_amt) ? $studentDetails->fee_amt : '' }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <div class="form-password-toggle">
                                                            <input type="date" name="first_instalment_date"
                                                                value="{{ isset($studentDetails->fee_date) ? date('Y-m-d', strtotime($studentDetails->fee_date)) : '' }}"
                                                                class="form-control flatpickr-input"
                                                                id="first_instalment_date" placeholder="DD-MM-YYYY">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        <label for="fee_mode">Fee Mode<sup
                                                                class="text-danger f-size12">*</sup></label>
                                                        <div class="form-password-toggle">
                                                            <select class="form-control" name="fee_mode" id="fee_mode"
                                                                required>
                                                                <option value="">-----Select----</option>
                                                                @if (isset($feeModes))
                                                                    @foreach ($feeModes as $feeMode)
                                                                        <option value="{{ $feeMode }}"
                                                                            {{ isset($studentDetails->fee_mode) && $studentDetails->fee_mode == $feeMode ? 'selected' : '' }}>
                                                                            {{ $feeMode }}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <input type="number" name="second_instalment_amount"
                                                            value="{{ isset($studentDetails->sec_i_amt) ? $studentDetails->sec_i_amt : '' }}"
                                                            class="form-control" id="second_instalment_amount"
                                                            placeholder="">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <div class="form-password-toggle">
                                                            <input type="date" name="second_instalment_date"
                                                                value="{{ isset($studentDetails->sec_i_date) ? date('Y-m-d', strtotime($studentDetails->sec_i_date)) : '' }}"
                                                                class="form-control flatpickr-input"
                                                                id="second_instalment_date" placeholder="DD-MM-YYYY">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <input type="number" name="third_instalment_amount"
                                                            value="{{ isset($studentDetails->third_i_amt) ? $studentDetails->third_i_amt : '' }}"
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <div class="form-password-toggle">
                                                            <input type="date" name="third_instalment_date"
                                                                value="{{ isset($studentDetails->third_i_date) ? date('Y-m-d', strtotime($studentDetails->third_i_date)) : '' }}"
                                                                class="form-control flatpickr-input"
                                                                id="third_instalment_date" placeholder="DD-MM-YYYY">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6 col-md-4 mb-1">
                                                        ...
                                                        <input type="number" name="discount"
                                                            value="{{ isset($studentDetails->discount) ? $studentDetails->discount : '' }}"
        ...
        <script>
            ...
            for (let index = 0; index < elements.length; index++) {
                elements[index].setAttribute("readonly", "true");
