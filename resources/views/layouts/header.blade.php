  ...
  <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            $userImage=Illuminate\support\facades\Auth::guard('admin')->user()->image;
            @endphp
            {{-- <span><strong>{{Illuminate\support\facades\Auth::user()->name}}({{$rolename}})</strong></span> --}}
            <span><strong>{{Illuminate\support\facades\Auth::guard('admin')->user()->name}} </strong></span>
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"></span><span class="user-status fs-4"></span></div><span class="avatar"><img class="round" src="{{asset('assets/ProfilePictures/'.$userImage.'')}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="{{route('profileForm')}}"><i class="me-50" data-feather="user"></i> Profile</a>
                    {{-- <a class="dropdown-item" href="{{route('profileForm')}}"><i class="me-50" data-feather="user"></i> Profile</a> --}}
