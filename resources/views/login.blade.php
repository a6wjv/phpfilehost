                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h3 class="card-title fw-bold mb-1">Welcome to File Manager</h3>
                                  ...
                                  @csrf
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password" >Password</label><a href="{{route('forgotpassword')}}"><small>Forgot Password?</small></a>
                                        </div>
                                    ...
                                    <button class="btn btn-primary w-100" type="submit" tytabindex="4">Sign in</button>
                                    <p class="role"></p>
                                </form>
                               {{-- Form End --}}
